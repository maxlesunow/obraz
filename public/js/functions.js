(function($){
    ...
    $(window).load(function() {
      // Resize Megamenu
        setTimeout(function() { boutique_resizeMegamenu(); }, 0)
        setTimeout(function() { init_carousel_mobile(); }, 0)
        setTimeout(function() { js_height_full(); }, 0)
        setTimeout(function() { js_width_full(); }, 0)
        setTimeout(function() { scrollbar_header_sidebar(); }, 0)
        setTimeout(function() { positionFootersidebar(); }, 0)
        setTimeout(function() { clone_main_menu(); }, 0)
        setTimeout(function() { heightheader_categoy_menu(); }, 0)
        setTimeout(function() { boutique_stick_menu(); }, 0)
        setTimeout(function() { clone_header_ontop(); }, 0)
        // init_popup();
    ...
    $(document).ready(function() {
        // OWL CAROUSEL
        setTimeout(function() { init_carousel(); }, 0)
        //MENU REPONSIIVE
        setTimeout(function() { init_menu_reposive(); }, 0)
        //SELECT CHOSEN
        $("select").chosen();
        // Resize Megamenu
        setTimeout(function() { boutique_resizeMegamenu(); }, 0)
        ...
        setTimeout(function() { heightheader_categoy_menu(); }, 0)
        setTimeout(function() { boutique_stick_menu(); }, 0)
        setTimeout(function() { tab_owl_fade_effect(); }, 0)
        setTimeout(function() { tab_product_fade_effect(); }, 0)
        setTimeout(function() { kt_parallax(); }, 0)
        // CATEGORY FILTER 
