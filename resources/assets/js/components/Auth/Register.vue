                            ...
                            <template v-for="input in inputs">
                                <div class="form-group" :class="{'has-error': input.hasErrors }">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input v-if="input.type === 'phone'" type="text" v-input-mask data-inputmask-mask="+7 (999) 999 999 99" :id="input.attr" class="form-control" :name="input.attr" v-model="input.data" :disabled="input.disabled" required autofocus>
