                    ...
                    <form class="form-horizontal" role="form">
                        <div class="modal-body">
                            ...
                            <div class="form-group" :class="{'has-error' : hasErrors.first_name}">
                                ...
                                <div class="col-md-6">
                                    <input id="first_name" type="text" class="form-control" name="first_name" v-model="registerData.first_name" required autofocus>
                            ...
                            <div class="form-group" :class="{'has-error' : hasErrors.last_name}">
                                ...
                                <div class="col-md-6">
                                    <input id="last_name" type="text" class="form-control" name="last_name" v-model="registerData.last_name" required autofocus>
                            ...
                            <div class="form-group" :class="{'has-error' : hasErrors.middle_name}">
                                ...
                                <div class="col-md-6">
                                    <input id="middle_name" type="text" class="form-control" name="middle_name" v-model="registerData.middle_name" required autofocus>
                            ...
                            <div class="form-group" :class="{'has-error' : hasErrors.email}">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control" name="email" v-model="registerData.email" required autofocus>
                            ...
                            <div class="form-group" :class="{'has-error' : hasErrors.phone}">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text" class="form-control" name="phone" v-model="registerData.phone" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" v-model="registerData.password_confirmation" required>
                                </div>
                            </div>
                        </div>
