...
@section('content')
    {{--LOGO FULL SIZE--}}
    <section class="section-top-50" style="overflow: hidden;">
        <div class="mock-up-wrapper veil reveal-sm-inline-block">
            <div><img class="mock-up-desktop img-responsive" src="images/logos/logo-full.png" height="300" alt=""></div>
        </div>
    </section>

    {{--TEXT--}}
    <section class="section-50 section-sm-top-50 section-sm-bottom-50 section-mock-up" id="home-section-welcome">
        <div class="shell">
            <div class="range range-xs-center">
                <div class="cell-md-10">
                    <h3>Консалтинговое пространство Образ</h3>
                    <p>это дружеское
    ...
    <section class="context-dark">
        <section class="section-50 section-top-45 bg-mantis section-triangle section-triangle-bottom">
            <div class="shell">
