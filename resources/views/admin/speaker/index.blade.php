...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h4 class="panel-title">Список докладчиков<a class="heading-elements-toggle"><i class="icon-more"></i></a>
            </h4>
        </div>
        ...
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper no-footer">
            <div class="datatable-header">
                ...
                <div class="dt-buttons">
                    <a class="btn bg-green" tabindex="0" href="{{ action ('SpeakerController@create') }}">
                    ...
                    <table class="table datatable-button-init-custom dataTable no-footer" id="DataTables_Table_1"
                        ...
                        @foreach($speakers as $speaker)
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    <a href="{{ action ('SpeakerController@edit', $speaker->id) }}">{{$speaker->full_name()}}</a>
                                </td>
                                {{--<td>{{$speaker->phone}}</td>--}}
                            </tr>
                        @endforeach
