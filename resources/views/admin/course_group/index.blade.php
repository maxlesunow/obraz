...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h4 class="panel-title">Список групп курсов<a class="heading-elements-toggle"><i class="icon-more"></i></a>
            </h4>
        </div>
        ...
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper no-footer">
            <div class="datatable-header">
                ...
                <div class="dt-buttons">
                    <a class="btn bg-green" tabindex="0" href="{{ action ('CourseGroupController@create') }}">
                    ...
                    <table class="table datatable-button-init-custom dataTable no-footer" id="DataTables_Table_1"
                        ...
                        @foreach($course_groups as $course_group)
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    <a href="{{ action ('CourseGroupController@edit', $course_group->id) }}">{{$course_group->name}}</a>
                                </td>
                                {{--<td>{{$course_group->phone}}</td>--}}
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
